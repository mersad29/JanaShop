 ...
 * <T>
 */
export type Type<T> = import('photoswipe/dist/types/types.js').Type<T>;
export type SlideData = import('photoswipe/dist/types/slide/slide.js').SlideData;
export type ZoomLevelOption = import('photoswipe/dist/types/slide/zoom-level.js').ZoomLevelOption;
export type UIElementData = import('photoswipe/dist/types/ui/ui-element.js').UIElementData;
export type ItemHolder = import('photoswipe/dist/types/main-scroll.js').ItemHolder;
export type PhotoSwipeEventsMap = import('photoswipe/dist/types/core/eventable.js').PhotoSwipeEventsMap;
export type PhotoSwipeFiltersMap = import('photoswipe/dist/types/core/eventable.js').PhotoSwipeFiltersMap;
export type Bounds = import('photoswipe/dist/types/slide/get-thumb-bounds').Bounds;
/**
 * <T>
 */
export type EventCallback<T extends keyof import("photoswipe/dist/types/core/eventable.js").PhotoSwipeEventsMap> = import('photoswipe/dist/types/core/eventable.js').EventCallback<T>;
/**
 * <T>
 */
export type AugmentedEvent<T extends keyof import("photoswipe/dist/types/core/eventable.js").PhotoSwipeEventsMap> = import('photoswipe/dist/types/core/eventable.js').AugmentedEvent<T>;
export type Point = {
    x: number;
    y: number;
    id?: string | number;
...
export type DataSource = import("photoswipe/dist/types/slide/slide.js").SlideData[] | DataSourceObject;
...
export type PreparedPhotoSwipeOptions = {
    ...
    initialZoomLevel?: import("photoswipe/dist/types/slide/zoom-level.js").ZoomLevelOption | undefined;
    secondaryZoomLevel?: import("photoswipe/dist/types/slide/zoom-level.js").ZoomLevelOption | undefined;
    maxZoomLevel?: import("photoswipe/dist/types/slide/zoom-level.js").ZoomLevelOption | undefined;
...
import PhotoSwipeBase from "photoswipe/dist/types/core/base.js";
import Slide from "photoswipe/dist/types/slide/slide.js";
import DOMEvents from "photoswipe/dist/types/util/dom-events.js";
import Animations from "photoswipe/dist/types/util/animations.js";
import MainScroll from "photoswipe/dist/types/main-scroll.js";
import Gestures from "photoswipe/dist/types/gestures/gestures.js";
import Opener from "photoswipe/dist/types/opener.js";
import Keyboard from "photoswipe/dist/types/keyboard.js";
import ContentLoader from "photoswipe/dist/types/slide/loader.js";
import ScrollWheel from "photoswipe/dist/types/scroll-wheel.js";
import UI from "photoswipe/dist/types/ui/ui.js";
