 ...
 * <T>
 */
export type Methods<T> = import('photoswipe/dist/types/types.js').Methods<T>;
...
export type UIElementData = {
    ...
    onClick?: import("photoswipe/dist/types/types.js").Methods<import("photoswipe").default> | ((e: MouseEvent, element: HTMLElement, pswp: PhotoSwipe) => void) | undefined;
