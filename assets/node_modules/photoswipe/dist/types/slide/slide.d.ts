...
declare class Slide {
    ...
    content: import("photoswipe/dist/types/slide/content.js").default;
     ...
     */
    zoomTo(destZoomLevel: number, centerPoint?: import("photoswipe").Point | undefined, transitionDuration?: number | false | undefined, ignoreBounds?: boolean | undefined): void;
    /**
     * @param {Point} [centerPoint]
     */
    toggleZoom(centerPoint?: import("photoswipe").Point | undefined): void;
    /**
     ...
     * @returns {number}
     */
    calculateZoomToPanOffset(axis: 'x' | 'y', point?: import("photoswipe").Point | undefined, prevZoomLevel?: number | undefined): number;
    /**
...
import ZoomLevel from "photoswipe/dist/types/slide/zoom-level.js";
import PanBounds from "photoswipe/dist/types/slide/pan-bounds.js";
