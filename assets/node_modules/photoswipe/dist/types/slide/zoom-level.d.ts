...
declare class ZoomLevel {
     ...
     */
    constructor(options: PhotoSwipeOptions, itemData: SlideData, index: number, pswp?: import("photoswipe").default | undefined);
    pswp: import("photoswipe").default | undefined;
    options: Partial<import("photoswipe").PreparedPhotoSwipeOptions>;
