"""
Django settings for JanaShop project.
...
SECRET_KEY = 'django-insecure-3bs(u))a*uch=^*^lkiq89hxd(8nw0(owae))np#(pw*2uz*#-'
...
WSGI_APPLICATION = 'JanaShop.wsgi.application'
